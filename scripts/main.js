...
},{"_process":4,"os":3}],2:[function(require,module,exports){
(function (global){
/*!
 * VERSION: 2.0.1
 * DATE: 2018-05-30
...
},{"./animations":5}],7:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onSVG = exports.resetSVG = undefined;
...
function resetSVG(progressBars) {
  ...
  try {
    for (var _iterator = progressBars[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      var circle = path.id.indexOf("lines-to__circle") >= 0 ? true : false;

      var fullLengthSVGPath = path.getTotalLength();

      if (circle) {
        fullLengthSVGPath = 2.8284270763397217;
      };
      var tl = new _gsap.TimelineMax();
      tl.to(path, 0, { strokeDasharray: fullLengthSVGPath, strokeDashoffset: fullLengthSVGPath });
    }
  } catch (err) {
    _didIteratorError = true;
    _iteratorError = err;
...
function onSVG(progressBars) {
  ...
  try {
    for (var _iterator2 = progressBars[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      ...
      var circle = path.id.indexOf("lines-to__circle") >= 0 ? true : false;
      var line_to = path.id.indexOf("lines-to__line") >= 0 ? true : false;
      if (line_to) {
        tl.to(path, 1, { strokeDashoffset: 0 }, '+=1');
      } else if (circle) {
        tl.to(path, 0.3, { strokeDashoffset: 0 }, '+=2');
      } else {
        tl.to(path, 1, { strokeDashoffset: 0 });
      }
    }
  } catch (err) {
    _didIteratorError2 = true;
...
window.addEventListener('load', function () {
  ...
  (0, _svg.resetSVG)(allSVGpath);(0, _svg.onSVG)(allSVGpath);
...
},{"./components/animations":5,"./components/listeners":6,"./components/svg":7,"./components/warnings":8,"detect-browser":1}]},{},[9])
