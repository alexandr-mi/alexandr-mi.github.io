...
window.addEventListener('load', function () {
  var $athletsSlider = $('.athlets__feature-list'),
      $playersSlider = $('.players__feature-list'),
      heroAnimation = void 0,
      athletsAnamation = void 0,
      playersAnamation = void 0,
      bottomAnamation = void 0;
  ...
  heroAnimation = new _wow2.default({
    boxClass: 'hero__title-wrap-decoration',
    animateClass: 'show'
  });

  athletsAnamation = new _wow2.default({
    boxClass: 'athlets__media',
    animateClass: 'show',
    offset: 200
  });

  playersAnamation = new _wow2.default({
    boxClass: 'players__media',
    animateClass: 'show',
    offset: 200
  });

  bottomAnamation = new _wow2.default({
