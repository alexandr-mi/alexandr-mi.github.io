...
},{"split-html-to-chars":2}],4:[function(require,module,exports){
'use strict';
...
var Sprite_animation = function () {
  ...
  _createClass(Sprite_animation, [{
    ...
    value: function create_sprite() {
      ...
      this.sprite = document.querySelector(this.selector + ' .sprite_animation');
    }
  }, {
    key: 'animation',
    value: function animation() {
      ...
      var now_col = 0;
      var now_row = 0;
      var iteration = this.col * this.row - this.offset;
    ...
    value: function animation_revers() {
      var _this2 = this;

      var iteration = this.col * this.row - this.offset;
      var counter = iteration;
      var now_col = this.col - this.offset - 1;
      var now_row = this.row - 1;
      var sprite_width = this.img_width / this.col * this.scale;
      var sprite_height = this.img_height / this.row * this.scale;
...
window.addEventListener('load', function () {
  ...
  function letter_animation(selector, animation) {
    var scene_b = new _scrollmagic2.default.Scene({ triggerElement: selector, duration: 0, offset: 10 }).on("enter", function (event) {
      animation.animation();
    }).on("leave", function (event) {
      animation.animation_revers();
    }).addTo(controller);
  }

  letter_animation('.card__letter-b', _animation_letter_var.animation.b);
  letter_animation('.card__letter-l', _animation_letter_var.animation.l);
  letter_animation('.card__letter-m', _animation_letter_var.animation.m);
  letter_animation('.card__letter-r', _animation_letter_var.animation.r);
  letter_animation('.card__letter-v', _animation_letter_var.animation.v);
  letter_animation('.card__letter-c', _animation_letter_var.animation.c);
});

},{"./animation_letter_var":6,"scrollmagic":1}],6:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.animation = exports.selector = undefined;
...
var animation = {
  b: new _Sprite_animation2.default({
    selector: selector.b,
    img: './images/sprite/sprite-b.png',
    img_width: 1716,
    img_height: 4158,
    col: 4,
    row: 11,
  ...
  l: new _Sprite_animation2.default({
    selector: selector.l,
    img: './images/sprite/sprite-l.png',
    img_width: 1716,
    img_height: 4158,
    col: 4,
    row: 11,
  ...
  m: new _Sprite_animation2.default({
    selector: selector.m,
    img: './images/sprite/sprite-m.png',
    img_width: 1716,
    img_height: 4158,
    col: 4,
    row: 11,
  ...
  r: new _Sprite_animation2.default({
    selector: selector.r,
    img: './images/sprite/sprite-r.png',
    img_width: 1716,
    img_height: 4158,
    col: 4,
    row: 11,
  ...
  v: new _Sprite_animation2.default({
    selector: selector.v,
    img: './images/sprite/sprite-v.png',
    img_width: 1716,
    img_height: 3780,
    col: 4,
    row: 10,
  ...
  c: new _Sprite_animation2.default({
    selector: selector.c,
    img: './images/sprite/sprite-c.png',
    img_width: 1716,
    img_height: 4158,
    col: 4,
    row: 11,
...
},{"./Sprite_animation":4}],7:[function(require,module,exports){
'use strict';
...
var gradient = {
  ...
  practical: '.design_item-practical .design_item__title',
  slip_resistant: '.design_item-slip-resistant .design_item__title',
  comfort: '.design_item-comfort .design_item__title',
  support: '.design_item-support .design_item__title',
  refinement: '.design_item-refinement .design_item__title'
};

new _Gradient2.default(gradient.style, '#19847B', '#36A056');
new _Gradient2.default(gradient.practical, '#5ADAC4', '#5AB9DC');
new _Gradient2.default(gradient.slip_resistant, '#549ECB', '#34BFD1');
new _Gradient2.default(gradient.comfort, '#F5BAB7', '#F094AF');
...
},{"./Gradient":3,"./Sprite_animation":4,"./animation_letter":5}]},{},[7])
